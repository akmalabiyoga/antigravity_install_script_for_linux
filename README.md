# antigravity_install_script_for_linux
Simple .sh script for installing antigravity and uninstall (adding proper .desktop file so you can run it and some chmod to important file)
